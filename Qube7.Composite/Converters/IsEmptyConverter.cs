...
{
    /// <summary>
    /// Represents the converter that converts an <see cref="IEnumerable"/> to a <see cref="Boolean"/> value by checking whether the sequence is <c>null</c> or contains no elements.
    /// </summary>
    public class IsEmptyConverter : ValueConverter
    {
        #region Fields

        /// <summary>
        /// Represents the cached instance of the <see cref="IsEmptyConverter"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IsEmptyConverter"/> class.
        /// </summary>
        ...
        /// <returns><c>true</c> if <paramref name="value"/> is sequence that is <c>null</c> or contains no elements; otherwise, <c>false</c>.</returns>
