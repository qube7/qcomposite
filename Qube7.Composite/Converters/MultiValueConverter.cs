...
{
    /// <summary>
    /// Provides a base class for implementations of the <see cref="IMultiValueConverter"/> interface.
    /// </summary>
    public abstract class MultiValueConverter : MarkupExtension, IMultiValueConverter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiValueConverter"/> class.
        /// </summary>
        ...
        /// <summary>
        /// When overridden in a derived class, converts source values to a value for the binding target. The data binding engine calls this method when it propagates the values from source bindings to the binding target.
        /// </summary>
        ...
        /// <summary>
        /// When overridden in a derived class, converts a binding target value to the source binding values. The data binding engine calls this method when it propagates a value from the binding target to the source bindings.
        /// </summary>
