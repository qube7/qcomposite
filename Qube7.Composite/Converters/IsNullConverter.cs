...
{
    /// <summary>
    /// Represents the converter that converts an <see cref="Object"/> to a <see cref="Boolean"/> value by checking whether the reference is <c>null</c> or <see cref="DBNull.Value"/>.
    /// </summary>
    public class IsNullConverter : ValueConverter
    {
        ...
        /// <summary>
        /// Represents the cached instance of the <see cref="IsNullConverter"/> class.
        /// </summary>
        ...
        /// <returns><c>true</c> if <paramref name="value"/> is <c>null</c> or <see cref="DBNull.Value"/>; otherwise, <c>false</c>.</returns>
        public override object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            return value == null || value == DBNull.Value ? BooleanBox.True : BooleanBox.False;
        }
