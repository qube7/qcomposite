...
{
    /// <summary>
    /// Represents a collection of keys and weakly referenced values.
    /// </summary>
    /// <typeparam name="TKey">The type of the keys in the dictionary.</typeparam>
    /// <typeparam name="TValue">The type of the values in the dictionary.</typeparam>
    [DebuggerDisplay("Count = {Count}")]
    public class WeakDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDisposable where TValue : class
    {
        #region Fields
        ...
        /// <summary>
        /// Gets a collection containing the keys in the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        /// <value>A collection containing the keys in the <see cref="WeakDictionary{TKey, TValue}"/>.</value>
        ...
        /// <summary>
        /// Gets a collection containing the values in the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        /// <value>A collection containing the values in the <see cref="WeakDictionary{TKey, TValue}"/>.</value>
        ...
        /// <summary>
        /// Gets the number of key/value pairs contained in the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        /// <value>The number of key/value pairs contained in the <see cref="WeakDictionary{TKey, TValue}"/>.</value>
        public int Count
        {
            get { return count; }
        }
        ...
        /// <summary>
        /// Gets a value indicating whether the <see cref="WeakDictionary{TKey, TValue}"/> is read-only.
        /// </summary>
        /// <value><c>false</c> indicating that the <see cref="WeakDictionary{TKey, TValue}"/> is not read-only.</value>
        ...
        /// <summary>
        /// Initializes the <see cref="WeakDictionary{TKey, TValue}"/> with the specified capacity.
        /// </summary>
        ...
        /// <summary>
        /// Ensures that the capacity of the <see cref="WeakDictionary{TKey, TValue}"/> is at least the specified value.
        /// </summary>
        ...
        /// <summary>
        /// Changes the current capacity of the <see cref="WeakDictionary{TKey, TValue}"/> to the specified value.
        /// </summary>
        ...
        /// <summary>
        /// Adds the specified key and value to the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Adds the specified key/value pair to the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Inserts the specified key and value to the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether the <see cref="WeakDictionary{TKey, TValue}"/> contains the specified key.
        /// </summary>
        /// <param name="key">The key to locate in the <see cref="WeakDictionary{TKey, TValue}"/>.</param>
        /// <returns><c>true</c> if the <see cref="WeakDictionary{TKey, TValue}"/> contains an element with the specified key; otherwise, <c>false</c>.</returns>
        ...
        /// <summary>
        /// Determines whether the <see cref="WeakDictionary{TKey, TValue}"/> contains the specified value.
        /// </summary>
        /// <param name="value">The value to locate in the <see cref="WeakDictionary{TKey, TValue}"/>.</param>
        /// <returns><c>true</c> if the <see cref="WeakDictionary{TKey, TValue}"/> contains an element with the specified value; otherwise, <c>false</c>.</returns>
        public bool ContainsValue(TValue value)
        {
            if (value == null)
            {
                for (int i = 0; i < lastIndex; i++)
                {
                    if (entries[i].hashCode >= 0 && entries[i].Target == null)
                    {
                        return true;
                    }
                }
            ...
            else
            {
                ...
                for (int i = 0; i < lastIndex; i++)
                {
                    if (entries[i].hashCode >= 0 && comparer.Equals(entries[i].Target, value))
                    {
                        return true;
                    }
                }
        ...
        /// <summary>
        /// Determines whether the <see cref="WeakDictionary{TKey, TValue}"/> contains the specified key/value pair.
        /// </summary>
        /// <param name="item">The key/value pair to locate in the <see cref="WeakDictionary{TKey, TValue}"/>.</param>
        /// <returns><c>true</c> if the <see cref="WeakDictionary{TKey, TValue}"/> contains the specified key/value pair; otherwise, <c>false</c>.</returns>
        bool ICollection<KeyValuePair<TKey, TValue>>.Contains(KeyValuePair<TKey, TValue> item)
        {
            int index = FindEntry(item.Key);

            return index >= 0 && EqualityComparer<TValue>.Default.Equals(entries[index].Target, item.Value);
        }
        ...
        /// <summary>
        /// Copies the elements of the <see cref="WeakDictionary{TKey, TValue}"/> to the specified array, starting at the specified index.
        /// </summary>
        /// <param name="array">The one-dimensional array that is the destination of the elements copied from the current <see cref="WeakDictionary{TKey, TValue}"/>.</param>
        ...
        void ICollection<KeyValuePair<TKey, TValue>>.CopyTo(KeyValuePair<TKey, TValue>[] array, int index)
        {
            ...
            for (int i = 0; i < lastIndex; i++)
            {
                ...
                {
                    array[index++] = KeyValuePair.Create(entries[i].key, entries[i].Target);
                }
            }
        }

        /// <summary>
        /// Returns an enumerator that iterates through the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        /// <returns>A enumerator that can be used to iterate through the <see cref="WeakDictionary{TKey, TValue}"/>.</returns>
        ...
        /// <summary>
        /// Removes the value with the specified key from the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Removes the specified key/value pair from the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        ...
        {
            int index = FindEntry(item.Key);
            if (index >= 0 && EqualityComparer<TValue>.Default.Equals(entries[index].Target, item.Value))
            {
                Remove(item.Key);
        ...
        /// <summary>
        /// Sets the capacity to the actual number of elements in the <see cref="WeakDictionary{TKey, TValue}"/>, if that number is less than a threshold value.
        /// </summary>
        ...
        /// <summary>
        /// Removes from the <see cref="WeakDictionary{TKey, TValue}"/> keys associated with the values that are no longer accessible.
        /// </summary>
        /// <returns>The number of elements removed from the <see cref="WeakDictionary{TKey, TValue}"/>.</returns>
        public int Purge()
        {
            return Purge(out _);
        }
        ...
        /// Removes from the <see cref="WeakDictionary{TKey, TValue}"/> keys associated with the values that are no longer accessible.
        /// </summary>
        /// <param name="array">The array of keys removed from the <see cref="WeakDictionary{TKey, TValue}"/>.</param>
        /// <returns>The number of elements removed from the <see cref="WeakDictionary{TKey, TValue}"/>.</returns>
        public int Purge(out TKey[] array)
        {
            ...
            for (int i = 0; i < lastIndex; i++)
            {
                if (entries[i].hashCode >= 0 && !entries[i].IsAlive)
                {
        ...
        /// <summary>
        /// Releases all resources used by the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Releases resources used by the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Defines the key/value pair stored in the <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        private class Entry : Weak<TValue>
        {
            #region Fields
            ...
            internal Entry(TValue value) : base(value)
            {
            }
        ...
        /// <summary>
        /// Enumerates the elements of a <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        private struct Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>
        {
            ...
            /// </summary>
            /// <value>The element in the <see cref="WeakDictionary{TKey, TValue}"/> at the current position of the enumerator.</value>
            public KeyValuePair<TKey, TValue> Current
            {
                get { return KeyValuePair.Create(current.key, current.Target); }
            }
            ...
            object IEnumerator.Current
            {
                get
                {
                    if (index == 0 || index > dictionary.lastIndex)
                    {
                        throw Error.InvalidOperation(Strings.EnumeratorInvalidPosition);
                    }

                    return KeyValuePair.Create(current.key, current.Target);
                }
            }
            ...
            internal Enumerator(WeakDictionary<TKey, TValue> dictionary) : this()
            {
            ...
            /// <summary>
            /// Advances the enumerator to the next element of the <see cref="WeakDictionary{TKey, TValue}"/>.
            /// </summary>
            ...
            public bool MoveNext()
            {
                ...
                while (index < dictionary.lastIndex)
                {
                    if (dictionary.entries[index].hashCode >= 0)
                    {
                        current = dictionary.entries[index++];
        ...
        /// <summary>
        /// Represents the collection of keys in a <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        [DebuggerDisplay("Count = {Count}")]
        private class KeyCollection : ICollection<TKey>
        {
            ...
            public void CopyTo(TKey[] array, int index)
            {
                ...
                int lastIndex = dictionary.lastIndex;
        ...
        /// <summary>
        /// Represents the collection of values in a <see cref="WeakDictionary{TKey, TValue}"/>.
        /// </summary>
        [DebuggerDisplay("Count = {Count}")]
